...
public static class ModHelperData
{
    ...
    public const string Name = "Bloons+ Mod (BETA)";

    public const string Description = "XStables's Mod, aka Bloons+, aims to expand your BTD6 experience. Adds in content from BTDX, as well as some all-original content!" +
        "\n\nFeatures:" +
        "\n- 30+ New Bloon Types" +
    ...
    public const string RepoOwner = "XStables"; // TODO add your github username hero, also in the download url in README.md
    public const string RepoName = "BloonsPlus"; // TODO add your repo name here, also in the download url in README.md
}